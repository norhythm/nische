...
`pykakasi` ライブラリで日本語をローマ字に変換し、英数字+ハイフンのスラグを生成。
重複時はサフィックス `-2`, `-3` を付与（4件該当）。
...
| 画像 | `public/temp/works/media/*` | 448 |
...
| スラグ | 作品 (ID) |
|---|---|
| `ansanburu-sutaazu-bright-me-up-mellow-dear-us-dear-world` | Dear World (29383) / Dear World (28354) |
| `ansanburu-sutaazu-bright-me-up-mellow-dear-us-mellow-addiction` | Mellow Addiction (29386) / Mellow Addiction (28357) |
| `butai-ansanburu-sutaazu-ekusutora-suteeji-memory-of-marionette` | Memory of Marionette (9787) / (9401) |
| `tv-anime-kyuuketsuki-sugu-shinu-kyarakutaasongu-iri-saundotorakku` | サウンドトラック② (15758) / ① (14920) |
...
tag:
  - mix
layout: "square"
image: "/temp/works/media/url-slug.jpg"
---
...
- `public/temp/works/media/*` → `public/works/media/` にコピー
- 各ファイルの `image` パスを `/temp/works/media/` → `/works/media/` に変更
